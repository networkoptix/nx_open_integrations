 ...
 *
 * Node.js port of ../../python/rest-list-cameras-cloud-user, on the latest
 * /rest/v4 API. Built-in `fetch` (Node 18+) and `node:test`, no deps.
 *
...
export class NxCloudSiteClient {
  constructor(
    ...
    password,
    siteId,
    { mfaCode = null, verifyTls = true, fetchImpl = fetch, timeout = 15000 } = {},
  ) {
   ...
   */
  async _getFollowingRedirects(url) {
