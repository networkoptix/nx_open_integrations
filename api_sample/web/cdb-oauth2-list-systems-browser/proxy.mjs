 ...
 *
 * This is a CLOUD-ONLY sample (it lists the account's Sites), so the proxy
 * needs only the /cloud route — there is no site relay and no 307 hop to
 * re-attach a bearer across. (For the relay flow, see the proxy in
 * ../rest-list-cameras-browser.)
 *
